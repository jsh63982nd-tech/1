...
- Textbook exercises with encoding/OCR review signals: 1

## Top Keywords (display-repaired)
- 화력발전: 18
- 분산전원: 18
- 발전기: 17
- 배전계통: 16
...
- 2x 3상송전계통에서중성점잔류전압에대하여설명하시오.
- 2x 고조파가전력용변압기에미치는영향과대책에대하여설명하시오.
- 2x 배전계통에서플리커(Flicker)와고조파의원인및대책에대하여설명하시오.
- 2x 전력계통의공급신뢰도향상대책에대하여설명하시오.
