...
const keywordCorrections = new Map([
  ...
  ["q-122-1-6", "직류조류계산"],
  ["q-123-4-1", "고압케이블열화진단"],
  ["q-126-1-6", "분산형전원 분리및재병입"],
  ["q-128-1-3", "태양광인버터"],
  ["q-129-3-1", "분산형전원 연계기술기준"],
  ["q-129-1-10", "PSS"],
  ["q-130-4-6", "계통연계유지"],
  ["q-134-3-6", "계통연계유지"],
  ["q-136-1-2", "계통연계유지"],
  ["q-137-1-1", "분산형전원 연계기술기준"],
  ["q-137-2-6", "분산형전원 분리및재병입"],
  ["q-137-4-2", "태양광인버터"]
]);
...
const topicGroups = [
  ...
  { name: "KEC/기준", keywords: ["KEC", "한국전기설비규정", "전기설비기술기준", "신뢰도및전기품질유지기준"] },
  {
    ...
    keywords: [
      ...
      "DER", "Hybrid", "연계용량", "공통연결점", "연계점", "접속점", "구내계통", "분리시간",
      "재병입", "단순병렬", "역송병렬", "단독운전방지", "계통연계유지", "FRT",
      "FaultRideThrough", "비정상전압", "비정상주파수", "직류유입", "순시전압변동",
      "전압요동", "전용선로", "공용변압기", "상계거래용변압기"
    ]
  },
  {
    name: "피뢰설비 보호범위",
    keywords: [
      "피뢰설비", "수뢰부", "보호범위", "보호각법", "회전구체법", "메시법", "보호등급",
      "보호레벨", "피뢰시스템", "회전구체반경", "메시치수", "보호각", "돌침",
      "수평도체", "메시도체", "뇌서지", "뇌전자임펄스", "직격뢰", "절연협조", "피뢰기"
    ]
  },
  {
    name: "전력설비 용어",
...
const bookOutlines = {
  "송배전공학": {
    source: "최신 송배전공학 / 이존우 송전공학 목차 / 한전 분산형전원 기준 / 피뢰설비 보호범위",
    chapters: [
      ...
      "분산형전원 배전계통 연계기술기준", "분산형전원 계통연계 유지", "분산형전원 보호장치",
      "피뢰설비 수뢰부 보호범위", "피뢰시스템 보호등급"
    ],
    keywords: [
      ...
      "분산형전원", "DER", "Hybrid분산형전원", "배전계통연계", "연계기술기준", "연계용량",
      "연계점", "접속점", "접속설비", "공통연결점", "분산형전원연결점", "구내계통",
      "단순병렬", "역송병렬", "단독운전", "자립운전", "단독운전방지", "분리시간",
      "비정상전압", "비정상주파수", "분리및재병입", "계통연계유지", "FRT", "FaultRideThrough",
      "운전지속시간", "순시전압변동", "직류유입", "전압요동", "역률유지", "보호장치설치",
      "과저전압계전기", "과저주파수계전기", "역전력계전기", "한류리액터", "공용변압기",
      "상계거래용변압기", "전용선로", "저압계통상시전압변동", "특고압계통상시전압변동",
      "피뢰설비", "수뢰부", "보호범위", "보호각법", "회전구체법", "메시법", "보호등급",
      "보호레벨", "회전구체반경", "메시치수", "보호각", "돌침", "수평도체", "메시도체",
      "뇌서지", "뇌전자임펄스", "직격뢰"
    ]
  },
  "발전공학": {
    ...
    keywords: [
      ...
      "CAES", "플라이휠저장", "전지에너지저장", "SMES", "발전소운용", "전력수요곡선",
      "유황곡선", "부하율", "설비이용률", "수력학", "베르누이정리", "유량곡선", "유량지속곡선",
      "조정지", "조압수조", "서지탱크", "취수구", "수압철관", "방수로", "프란시스수차",
      "펠턴수차", "카플란수차", "흡출관", "수격작용", "캐비테이션", "비속도", "무구속속도",
      "열효율", "카르노사이클", "재열사이클", "재생사이클", "미분탄", "급수펌프", "복수기",
      "탈기기", "급수가열기", "연소장치", "통풍장치", "집진장치", "배연탈황", "복합발전",
      "가스터빈", "디젤발전", "열병합", "분산형전원", "노심", "제어봉", "비상노심냉각",
      "냉각재상실사고", "방사선차폐", "원전안전", "태양광발전", "풍차", "해양온도차",
      "조력발전", "파력발전", "지열발전", "바이오매스", "압축공기에너지저장", "플라이휠",
      "초전도자기에너지저장"
    ]
  },
  "계통공학": {
